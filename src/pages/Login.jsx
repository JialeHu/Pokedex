...
function Login() {
    ...
    function submit(event) {
        ...
        const request = new Request("/rest-auth/login/", {
            method: "POST",
                ...
                <Col md="auto" xs="auto">
                    <Form onSubmit={submit}>
                        <Form.Group controlId="formBasicEmail">
                            ...
                            <Form.Control className="form-control" type="email" placeholder="Enter email" value={email} onChange={val => setEmail(val.target.value)} required autoFocus/>
                        </Form.Group>
